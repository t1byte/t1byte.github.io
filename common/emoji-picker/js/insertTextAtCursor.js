            ...
            if (canManipulateViaTextNodes(e)) {
                ...
                if (o) {
                    ...
                    for (; o && (null === t || null === n);) {
                        ...
                        a >= e && a <= e + r && l.setStart(t = o, a - e), s >= e && s <= e + r && l.setEnd(n = o, s - e), e += r, o = o.nextSibling
                    }
                    a !== s && l.deleteContents()
                } else e.appendChild(n)
            }
            if (canManipulateViaTextNodes(e) && "#text" === l.commonAncestorContainer.nodeName) l.insertNode(n);
            else {
                const c = e.value;
